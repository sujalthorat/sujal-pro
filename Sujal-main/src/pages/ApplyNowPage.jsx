    ...
    <div>
      ...
      <div className="container">
        <div className="content">
          ...
          <p>
            Welcome to the Admissions page of Vivekanand College! We are
          ...
          <ol>
            <li>
              <b>Online Application:</b> Fill out the application form available
              on our portal.
            </li>
            <li>
            ...
            <li>
              <b>Entrance Exam (if applicable):</b> Appear for the college's
              entrance examination.
            </li>
            <li>
              <b> Merit List & Interview:</b> Check the merit list and attend
              the interview if shortlisted.
            </li>
            <li>
